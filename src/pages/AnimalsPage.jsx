...
import { animalsData, animalGames } from '../data/natureData';
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <main className="px-4 py-4">
        <LearningCard item={currentAnimal} />

        <NavigationButtons
          onPrev={goPrev}
          onNext={goNext}
          hasPrev={currentIndex > 0}
          hasNext={currentIndex < animalsData.length - 1}
        ...
        <div className="max-w-md mx-auto mt-6">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-violet-200 to-purple-200 rounded-2xl font-bold text-lg shadow-md hover:scale-105 transition-transform"
          >
